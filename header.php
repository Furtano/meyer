    ...
    <div class="col-xs-12" style="padding-left:0px; padding-right:0px;padding-top: 0px;">
      ...
      <div class="wpcntent col-xs-10 col-lg-10">
        ...
        <div class="col-xs-12" style="padding-left:0px; padding-right:18px;padding-top:0px;">
          <div id="logologo" class="col-xs-3">
          ...
          <div class="col-xs-9 hidden-xs hidden-sm " id="bgheader">
          </div>
        </div>
        ...
        <div class="col-xs-12" style="padding-bottom: 15px" >
          ...
          <!-- <div class="collapse navbar-collapse"> -->
             <ul class="nav navbar-nav">
              ...
              -->
              <li class="dropdown "><a href="#" id="drop1" data-toggle="dropdown" class="dropdown-toggle" role="button">Einzelberatung <b class="caret"></b></a>
                  <ul role="menu" class="dropdown-menu" aria-labelledby="drop1">

              <li><a href="einzelberatung" role="menuitem">Ernährungstherapie</a></li>
              <li><a href="bia" role="menuitem">BIA-Messung</a></li>
              </ul>
             </li>
               ...
               <li><a href="bewegung">Bewegung</a></li>
